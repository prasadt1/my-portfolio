...
const ProductsPage: React.FC = () => {
    return (
        <>
            <SEO
                title="Battle-Tested Toolkits & Frameworks | Prasad Tilloo"
                description="Accelerate your transformation with proven frameworks and toolkits for Industry 4.0, HIPAA Compliance, and IT Effectiveness."
                keywords="Industry 4.0 Toolkit, HIPAA Compliance Package, IT Assessment Framework, Enterprise Toolkits"
                type="website"
            />
